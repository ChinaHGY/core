...
public class RowMapperBuilder {
	...
	private static class AutoRowMapper<T> {
		...
		/** 数据列名到 setter 名称的映射 */
		private Map<String, String> colName2SetterMap = new HashMap<>();
		/** setter 名称到 setter 方法的映射 */
		private Map<String, Method> setterMap = new HashMap<>();
		/** setter 名称到 setter 参数类型的映射 */
		private Map<String, String> setterParamMap = new HashMap<>();
